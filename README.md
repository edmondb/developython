...
3. After installing Anaconda, copy `C:\Python27\ArcGIS10.x\Lib\site-packages\Desktop10.x.pth` to `C:\Users\`__username__`\AppData\Local\Continuum\Anaconda2\Lib\site_packages\`.
